...
class UActivitiElement extends Component {
  ...
  render() {
    return (
      <>
        <blockquote id='UActivitiElement' className={styles.blockquote}>使用详解：标签元素</blockquote>
        <div>
          <Table bordered size='small' columns={this.columns} dataSource={this.dataSource}/>
        </div>
      </>
    );
  }
