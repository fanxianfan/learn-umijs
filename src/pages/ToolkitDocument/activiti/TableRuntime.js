      ...
      <>
        ...
        <ul>
          ...
          <li id='@act_ru_execution'>
            <b>流程实例与分支执行信息表（act_ru_execution）</b>
            <p>
            ...
            <ol>
              ...
              <li><b>ACT_ID_：</b>当前执行的节点ID，ID在流程文件中定义</li>
              <li><b>IS_ACTIVE_：</b>执行流是否活跃的标识</li>
              <li><b>IS_CONCURRENT_：</b>执行流是否正在并行</li>
              <li><b>IS_SCOPE_：</b>是否全局流程执行，0非，1是</li>
          ...
          <li id='@act_ru_identitylink'>
            <b>参与者相关信息表（act_ru_identitylink）</b>
            <ol>
              <li><b>ID_：</b>主键</li>
              <li><b>REV_：</b>数据版本号</li>
